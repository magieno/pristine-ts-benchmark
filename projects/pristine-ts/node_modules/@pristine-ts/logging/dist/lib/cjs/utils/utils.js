    ...
    static outputLog(log, outputMode, logDepth, spaceNumber = 0) {
        ...
        switch (outputMode) {
            case output_mode_enum_1.OutputModeEnum.Json:
                ...
                const truncatedLogKeys = Utils.getDeepKeys(truncatedLog).filter((truncatedLogKey) => jsonSortOrders.find(element => element === truncatedLogKey) === undefined);
            ...
            case output_mode_enum_1.OutputModeEnum.Simple:
                return (0, format_1.default)(log.date, "yyyy-MM-dd HH:mm:ss") + " - " + " [" + this.getSeverityText(log.severity) + "] - " + log.message + " - " + JSON.stringify(Utils.truncate(log.extra, 2));
        }
    }
    /**
