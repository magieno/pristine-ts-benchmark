...
const dynamodb_item_not_found_error_1 = require("../errors/dynamodb-item-not-found.error");
const dynamodb_item_already_exists_error_1 = require("../errors/dynamodb-item-already-exists.error");
const dynamodb_table_not_found_error_1 = require("../errors/dynamodb-table-not-found.error");
const dynamodb_validation_error_1 = require("../errors/dynamodb-validation.error");
const dynamodb_error_1 = require("../errors/dynamodb.error");
const common_1 = require("@pristine-ts/common");
const aws_module_keyname_1 = require("../aws.module.keyname");
const list_result_1 = require("../results/list.result");
const dynamodb_sort_order_enum_1 = require("../enums/dynamodb-sort-order.enum");
/**
...
let DynamodbClient = class DynamodbClient {
    ...
    getClient() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return this.client = (_a = this.client) !== null && _a !== void 0 ? _a : new client_dynamodb_1.DynamoDB({ region: this.region });
        });
    }
    /**
    ...
    getMapperClient() {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            return this.mapperClient = (_a = this.mapperClient) !== null && _a !== void 0 ? _a : new dynamodb_data_mapper_1.DataMapper({ client: yield this.getClient() });
        });
    }
    /**
    ...
    getTableName(classTypePrototype) {
        return classTypePrototype[dynamodb_data_mapper_1.DynamoDbTable];
    }
    /**
    ...
    get(classType, primaryKeyAndValue) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.logHandler.debug("DYNAMODB CLIENT - Got item", { item }, aws_module_keyname_1.AwsModuleKeyname);
                return item;
            }
            catch (error) {
                error = this.convertError(error, this.getTableName(classType.prototype), Object.keys(primaryKeyAndValue)[0]);
                if (error instanceof dynamodb_item_not_found_error_1.DynamodbItemNotFoundError) {
                    this.logHandler.warning("DYNAMODB CLIENT - Error getting", { error, classType, primaryKeyAndValue }, aws_module_keyname_1.AwsModuleKeyname);
                    return null;
                }
                else {
                    this.logHandler.error("DYNAMODB CLIENT - Error getting", { error, classType, primaryKeyAndValue }, aws_module_keyname_1.AwsModuleKeyname);
                }
                throw error;
            }
        });
    ...
    list(options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.logHandler.debug("DYNAMODB CLIENT - List items", { items }, aws_module_keyname_1.AwsModuleKeyname);
                const paginationResult = {
                    count: paginator.count,
                    lastEvaluatedKey: paginator.lastEvaluatedKey,
                };
                return new list_result_1.ListResult(items, paginationResult);
            }
            catch (error) {
                error = this.convertError(error, this.getTableName(options.classType.prototype));
                this.logHandler.error("DYNAMODB CLIENT - Error listing", { error, options, AwsModuleKeyname: aws_module_keyname_1.AwsModuleKeyname });
                throw error;
            }
        });
    }
    ...
    create(item) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                throw new dynamodb_item_already_exists_error_1.DynamodbItemAlreadyExistsError();
            }
            catch (error) {
                ...
                if (error instanceof dynamodb_item_not_found_error_1.DynamodbItemNotFoundError) {
                    try {
                        ...
                        this.logHandler.debug("DYNAMODB CLIENT - Created item", { item }, aws_module_keyname_1.AwsModuleKeyname);
                        return item;
                    }
                    catch (e) {
                        e = this.convertError(e, this.getTableName(item.constructor.prototype));
                        this.logHandler.error("DYNAMODB CLIENT - Error creating", { e, item }, aws_module_keyname_1.AwsModuleKeyname);
                        throw e;
                    }
                }
                throw error;
    ...
    update(item) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.logHandler.debug("DYNAMODB CLIENT - Updated item", { item }, aws_module_keyname_1.AwsModuleKeyname);
                return item;
            }
            catch (error) {
                //TODO: Get the primary key.
                error = this.convertError(error, this.getTableName(item.constructor.prototype));
                this.logHandler.error("DYNAMODB CLIENT - Error updating", { error, item }, aws_module_keyname_1.AwsModuleKeyname);
                throw error;
            }
        });
    }
    ...
    put(item) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                item = yield (yield this.getMapperClient()).put(item);
                this.logHandler.debug("DYNAMODB CLIENT - Put item", { item }, aws_module_keyname_1.AwsModuleKeyname);
                return item;
            }
            catch (error) {
                error = this.convertError(error, this.getTableName(item.constructor.prototype));
                this.logHandler.error("DYNAMODB CLIENT - Error putting", { error, item }, aws_module_keyname_1.AwsModuleKeyname);
                throw error;
            }
        });
    }
    ...
    delete(classType, primaryKeyAndValue) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.logHandler.debug("DYNAMODB CLIENT - Deleted item", { item }, aws_module_keyname_1.AwsModuleKeyname);
                return;
            }
            catch (error) {
                error = this.convertError(error, this.getTableName(classType.prototype), Object.keys(primaryKeyAndValue)[0]);
                this.logHandler.error("DYNAMODB CLIENT - Error deleting", { error, classType, primaryKeyAndValue }, aws_module_keyname_1.AwsModuleKeyname);
                throw error;
            }
        });
    }
    ...
    findBySecondaryIndex(options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                queryOptions.scanIndexForward = ((_b = options === null || options === void 0 ? void 0 : options.pagination) === null || _b === void 0 ? void 0 : _b.order) === dynamodb_sort_order_enum_1.DynamodbSortOrderEnum.Asc;
                this.logHandler.debug("DYNAMODB CLIENT - Querying with options", { queryOptions, options }, aws_module_keyname_1.AwsModuleKeyname);
                ...
                this.logHandler.debug("DYNAMODB CLIENT - Found items", { items }, aws_module_keyname_1.AwsModuleKeyname);
                const paginationResult = {
                    count: paginator.count,
                    lastEvaluatedKey: paginator.lastEvaluatedKey,
                };
                ...
                error = this.convertError(error, this.getTableName(options.classType.prototype));
                this.logHandler.error("DYNAMODB CLIENT - Error finding by secondary index", { error, options }, aws_module_keyname_1.AwsModuleKeyname);
                throw error;
            }
        });
    }
            ...
            if (filterKeysAndValues.hasOwnProperty(key)) {
                ...
                if (Array.isArray(filterKeysAndValues[key])) {
                    ...
                    for (const value of filterKeysAndValues[key]) {
                        orExpressions.push(Object.assign(Object.assign({}, (0, dynamodb_expressions_1.equals)(value)), { subject: key }));
                    }
                    const orExpression = {
                        type: "Or",
                    ...
                    conditions.push(Object.assign(Object.assign({}, (0, dynamodb_expressions_1.equals)(filterKeysAndValues[key])), { subject: key }));
                }
            }
        }
        return conditions;
    ...
    createExpiresAtFilter(expiresAtFilter) {
        ...
        const greaterThanExpression = Object.assign(Object.assign({}, (0, dynamodb_expressions_1.greaterThan)(value)), { subject: Object.keys(expiresAtFilter)[0] });
    ...
    convertError(error, tableName, primaryKey) {
        this.logHandler.debug("Converting error to dynamodb error.", { error, tableName, primaryKey }, aws_module_keyname_1.AwsModuleKeyname);
        if (error instanceof dynamodb_error_1.DynamodbError) {
            return error;
        }
        if (error.hasOwnProperty("name") === true) {
            switch (error.name) {
                case "ResourceNotFoundException":
                    return new dynamodb_table_not_found_error_1.DynamodbTableNotFoundError(error, tableName);
                case "ItemNotFoundException":
                    return new dynamodb_item_not_found_error_1.DynamodbItemNotFoundError(error, tableName, primaryKey);
                case "ValidationException":
                    return new dynamodb_validation_error_1.DynamodbValidationError(error, tableName, primaryKey);
                default:
                    return new dynamodb_error_1.DynamodbError("Unknown dynamodb error: " + error.name, error, tableName, primaryKey);
            }
        }
        return new dynamodb_error_1.DynamodbError("Unknown dynamodb error", error, tableName, primaryKey);
    }
    /**
...
DynamodbClient = __decorate([
    (0, common_1.tag)("DynamodbClientInterface"),
