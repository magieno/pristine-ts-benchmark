...
class DynamodbValidationError extends dynamodb_error_1.DynamodbError {
    ...
    constructor(originalError, tableName, primaryKey) {
        super("Validation error in dynamodb.", originalError, tableName);
...
exports.DynamodbValidationError = DynamodbValidationError;
//# sourceMappingURL=dynamodb-validation.error.js.map