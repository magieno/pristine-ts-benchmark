...
class EnumResolver {
    ...
    resolveString(value, enumClass) {
        ...
        throw new configuration_resolver_error_1.ConfigurationResolverError("Cannot convert the string to a key of the enum.", value);
    }
    /**
    ...
    resolveNumber(value, enumClass) {
        ...
        throw new configuration_resolver_error_1.ConfigurationResolverError("Cannot convert the number to a value of the enum.", value);
    }
    /**
    ...
    resolveValueOrResolver(value, enumClass) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            throw new configuration_resolver_error_1.ConfigurationResolverError("Cannot resolve the value passed. It isn't of type string, number or ResolverInterface.", value);
        });
    }
    /**
