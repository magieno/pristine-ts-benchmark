...
class BooleanResolver {
    ...
    resolveString(value) {
        ...
        throw new configuration_resolver_error_1.ConfigurationResolverError("Cannot convert the string to a boolean.", {
            value
        });
    }
    /**
    ...
    resolveValueOrResolver(value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            throw new configuration_resolver_error_1.ConfigurationResolverError("Cannot resolve the value passed. It isn't of type boolean, string, number or ResolverInterface.", {
                value,
            });
        });
    }
...
//# sourceMappingURL=boolean.resolver.js.map