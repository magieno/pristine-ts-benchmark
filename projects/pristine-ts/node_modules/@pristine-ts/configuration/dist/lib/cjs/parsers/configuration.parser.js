...
let ConfigurationParser = class ConfigurationParser {
    ...
    resolve(moduleConfigurationValue, container) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            throw new configuration_validation_error_1.ConfigurationValidationError(["The configuration value passed contains an unsupported type. Unsupported type: '" + typeof resolvedValue + "'"]);
        });
    }
};
