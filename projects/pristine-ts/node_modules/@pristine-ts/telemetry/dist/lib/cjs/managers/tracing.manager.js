...
let TracingManager = class TracingManager {
    ...
    startTracing(spanRootKeyname = span_keyname_enum_1.SpanKeynameEnum.RootExecution, traceId, context) {
        ...
        if (this.debug) {
            this.loghandler.debug("Start Tracing", {
                ...
                trace: this.trace,
                span,
            }, telemetry_module_keyname_1.TelemetryModuleKeyname);
        }
    ...
    addSpan(span) {
        ...
        if (this.trace === undefined) {
            this.loghandler.error("You cannot call 'addSpan' without having an existing Trace.", { span }, telemetry_module_keyname_1.TelemetryModuleKeyname);
            return span;
        }
