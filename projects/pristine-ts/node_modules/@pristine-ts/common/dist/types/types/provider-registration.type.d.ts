 ...
 */
export declare type ProviderRegistration<T = any> = FactoryProviderRegistrationInterface<T> | TokenProviderRegistrationInterface<T> | ValueProviderRegistrationInterface<T>;
