...
BodyParameterDecoratorResolver = __decorate([
    moduleScoped(NetworkingModuleKeyname),
    tag(ServiceDefinitionTagEnum.MethodParameterDecoratorResolver),
    injectable()
], BodyParameterDecoratorResolver);
export { BodyParameterDecoratorResolver };
//# sourceMappingURL=body-parameter-decorator.resolver.js.map