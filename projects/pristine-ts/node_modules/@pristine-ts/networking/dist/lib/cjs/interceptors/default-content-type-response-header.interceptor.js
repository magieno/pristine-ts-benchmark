...
DefaultContentTypeResponseHeaderInterceptor = __decorate([
    ...
    __param(0, (0, tsyringe_1.inject)(`%${networking_module_keyname_1.NetworkingModuleKeyname}.defaultContentTypeResponseHeader%`)),
    __param(1, (0, tsyringe_1.inject)(`%${networking_module_keyname_1.NetworkingModuleKeyname}.defaultContentTypeResponseHeader.isActive%`)),
