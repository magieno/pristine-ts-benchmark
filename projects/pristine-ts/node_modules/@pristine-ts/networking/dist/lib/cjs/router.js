...
const path_router_node_1 = require("./nodes/path-router.node");
...
let Router = class Router {
    ...
    getRouteTreeLevel(node, message, level) {
        for (const child of node.children) {
            ...
            if (child instanceof path_router_node_1.PathRouterNode) {
                message += "--" + child.path + "\n";
            }
            if (child instanceof method_router_node_1.MethodRouterNode) {
    ...
    register(path, method, route) {
        const splitPaths = url_util_1.UrlUtil.splitPath(path);
    ...
    setup() {
        ...
        controller_decorator_1.controllerRegistry.forEach(controller => {
            ...
            for (const methodPropertyKey in (_c = controller.__metadata__) === null || _c === void 0 ? void 0 : _c.methods) {
                ...
                route.context = (0, lodash_1.mergeWith)({}, (_j = (_h = controller.__metadata__) === null || _h === void 0 ? void 0 : _h.controller) === null || _j === void 0 ? void 0 : _j.__routeContext__, method.__routeContext__);
    ...
    execute(request, container) {
        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (error instanceof forbidden_http_error_1.ForbiddenHttpError === false) {
                    error = new forbidden_http_error_1.ForbiddenHttpError("You are not allowed to access this.");
                }
                routerRequestExecutionSpan.end();
            ...
            try {
                ...
                if ((yield this.authorizerManager.isAuthorized(request, methodNode.route.context, container, identity)) === false) {
                    ...
                    routerRequestExecutionSpan.end();
                    return resolve(this.executeErrorResponseInterceptors(new forbidden_http_error_1.ForbiddenHttpError("You are not allowed to access this."), request, container, methodNode));
                }
                // Execute all the interceptors
                const requestInterceptorsSpan = tracingManager.startSpan(telemetry_1.SpanKeynameEnum.RequestInterceptors, telemetry_1.SpanKeynameEnum.RouterRequestExecution);
                ...
                if (response instanceof common_1.Response) {
                    ...
                    returnedResponse = new common_1.Response();
                ...
                const responseInterceptorsSpan = tracingManager.startSpan(telemetry_1.SpanKeynameEnum.ResponseInterceptors, telemetry_1.SpanKeynameEnum.RouterRequestExecution);
    ...
    executeRequestInterceptors(request, container, methodNode) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (container.isRegistered(common_1.ServiceDefinitionTagEnum.RequestInterceptor, true)) {
                const interceptors = container.resolveAll(common_1.ServiceDefinitionTagEnum.RequestInterceptor);
                for (const interceptor of interceptors) {
                    ...
                    try {
                        ...
                        this.loghandler.error("There was an exception thrown while executing the 'interceptedRequest' method of the RequestInterceptor named: '" + interceptor.constructor.name + "'.", { e }, networking_module_keyname_1.NetworkingModuleKeyname);
                        throw e;
                    }
                }
            }
            ...
            if (container.isRegistered(common_1.ServiceDefinitionTagEnum.RequestInterceptor, true)) {
                ...
                for (const interceptor of interceptors) {
                    ...
                    if (typeof interceptor.interceptResponse === "undefined") {
                        ...
                        this.loghandler.info("Router - The Request Interceptor doesn't implement the interceptResponse method.", { name: interceptor.constructor.name, interceptor }, networking_module_keyname_1.NetworkingModuleKeyname);
                        continue;
                    }
                    try {
                        ...
                        this.loghandler.error("Router - There was an exception thrown while executing the 'interceptResponse' method of the RequestInterceptor named: '" + interceptor.constructor.name + "'.", { e }, networking_module_keyname_1.NetworkingModuleKeyname);
                        throw e;
                    }
                }
            }
    ...
    executeErrorResponseInterceptors(error, request, container, methodNode) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Execute all the request interceptors
            let interceptedResponse = new common_1.Response();
            ...
            if (container.isRegistered(common_1.ServiceDefinitionTagEnum.RequestInterceptor, true)) {
                ...
                for (const interceptor of interceptors) {
                    ...
                    try {
                        ...
                        this.loghandler.error("There was an exception thrown while executing the 'interceptError' method of the RequestInterceptor named: '" + interceptor.constructor.name + "'.", { e }, networking_module_keyname_1.NetworkingModuleKeyname);
                        throw e;
                    }
                }
            }
...
Router = __decorate([
    (0, common_1.tag)("RouterInterface"),
