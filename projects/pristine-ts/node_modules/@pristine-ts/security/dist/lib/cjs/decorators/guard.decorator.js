...
const guard = (guard, options) => {
    return (target, propertyKey, descriptor) => {
        ...
        if (!(guard && ((typeof guard === 'function' && typeof guard.prototype.isAuthorized === 'function') ||
            ...
            throw new guard_decorator_error_1.GuardDecoratorError("The guard isn't valid. It isn't a function or doesn't implement the 'isAuthorized' method.", guard, options, target, propertyKey, descriptor);
        }
        // Construct the Guard Context.
        const guardContext = {
            constructorName: guard.prototype.constructor.name,
            guard,
            options,
        };
