...
import { BinarySet, Marshaller, NumberValueSet, } from '@awslabs-community-fork/dynamodb-auto-marshaller';
 ...
 */
export function marshallItem(schema, input) {
    const marshalled = {};
 ...
 */
export function marshallValue(schemaType, input) {
    if (input === undefined) {
    ...
    if (schemaType.type === 'Set') {
        ...
        throw new InvalidSchemaError(schemaType, `Unrecognized set member type: ${schemaType.memberType}`);
    }
