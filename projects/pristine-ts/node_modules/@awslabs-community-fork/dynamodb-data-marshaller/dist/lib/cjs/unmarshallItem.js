...
function unmarshallValue(schemaType, input) {
    switch (schemaType.type) {
        ...
        case 'Hash':
            ...
            const autoMarshaller = new dynamodb_auto_marshaller_1.Marshaller({ onEmpty, onInvalid, unwrapNumbers });
        ...
        case 'Set':
            switch (schemaType.memberType) {
                ...
                default:
                    throw new InvalidSchemaError_1.InvalidSchemaError(schemaType, `Unrecognized set member type: ${schemaType}`);
            }
        case 'String':
