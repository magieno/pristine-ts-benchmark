 ...
 */
export declare function marshallItem(schema: Schema, input: {
    [key: string]: any;
}): {
 ...
 */
export declare function marshallValue(schemaType: SchemaType, input: any): AttributeValue | undefined;
