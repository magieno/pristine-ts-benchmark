 ...
 */
export declare type TypeTag = keyof typeof TypeTags;
/**
 ...
 */
export declare type KeyType = keyof typeof KeyTypes;
/**
 ...
 */
export interface CollectionType extends BaseType<Array<any>>, MarshallingOptions {
    type: 'Collection';
}
/**
...
export declare function isSchemaType(arg: any, alreadyVisited?: Set<any>): arg is SchemaType;
