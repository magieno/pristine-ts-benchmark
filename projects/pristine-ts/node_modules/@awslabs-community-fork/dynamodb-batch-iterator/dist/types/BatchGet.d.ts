 ...
 * per-table basis.
 */
export declare class BatchGet extends BatchOperation<{
     ...
     */
    constructor(client: DynamoDB, items: SyncOrAsyncIterable<[string, {
        [key: string]: AttributeValue;
    }]>, { ConsistentRead, PerTableOptions, }?: BatchGetOptions);
    protected doBatchRequest(): Promise<void>;
    protected getInitialTableState(tableName: string): TableState<{
        [key: string]: AttributeValue;
    }>;
}
