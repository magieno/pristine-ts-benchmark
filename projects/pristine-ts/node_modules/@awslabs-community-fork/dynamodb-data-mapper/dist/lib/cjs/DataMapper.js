...
const ParallelScanIterator_1 = require("./ParallelScanIterator");
const protocols_1 = require("./protocols");
const QueryIterator_1 = require("./QueryIterator");
const ScanIterator_1 = require("./ScanIterator");
const dynamodb_batch_iterator_1 = require("@awslabs-community-fork/dynamodb-batch-iterator");
...
class DataMapper {
    ...
    batchGet(items, { readConsistency = this.readConsistency, perTableOptions = {} } = {}) {
        return __asyncGenerator(this, arguments, function* batchGet_1() {
            ...
            const state = {};
            const options = {};
            const batch = new dynamodb_batch_iterator_1.BatchGet(this.client, this.mapGetBatch(items, state, perTableOptions, options), {
            ...
            try {
                for (var batch_1 = __asyncValues(batch), batch_1_1; batch_1_1 = yield __await(batch_1.next()), !batch_1_1.done;) {
                    ...
                    yield yield __await(dynamodb_data_marshaller_1.unmarshallItem(schema, marshalled, constructor));
                }
            }
    ...
    batchWrite(items) {
        return __asyncGenerator(this, arguments, function* batchWrite_1() {
            var e_6, _a;
            const state = {};
            const batch = new dynamodb_batch_iterator_1.BatchWrite(this.client, this.mapWriteBatch(items, state));
            try {
    ...
    createTable(valueConstructor, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { attributes, indexKeys, tableKeys } = dynamodb_data_marshaller_1.keysFromSchema(schema);
            ...
            if (TableStatus !== 'ACTIVE') {
                yield client_dynamodb_1.waitForTableExists({
                    client: this.client,
    ...
    createGlobalSecondaryIndex(valueConstructor, indexName, { indexOptions = {}, }) {
        return __awaiter(this, void 0, void 0, function* () {
            const schema = protocols_1.getSchema(valueConstructor.prototype);
            const { attributes, indexKeys } = dynamodb_data_marshaller_1.keysFromSchema(schema);
            const TableName = this.getTableName(valueConstructor.prototype);
    ...
    delete(itemOrParameters, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const schema = protocols_1.getSchema(item);
            const req = {
            ...
            if (Attributes) {
                return dynamodb_data_marshaller_1.unmarshallItem(schema, Attributes, item.constructor);
            }
        });
    }
    /**
    ...
    deleteTable(valueConstructor) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield client_dynamodb_1.waitForTableNotExists({
                client: this.client,
                maxWaitTime: 20 * 25, // seems to be the old default value
            }, { TableName });
        });
    ...
    get(itemOrParameters, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (projection) {
                const attributes = new dynamodb_expressions_1.ExpressionAttributes();
                req.ProjectionExpression = dynamodb_expressions_1.serializeProjectionExpression(projection.map(propName => dynamodb_data_marshaller_1.toSchemaName(propName, schema)), attributes);
                if (Object.keys(attributes.names).length > 0) {
                    req.ExpressionAttributeNames = attributes.names;
                }
            }
            ...
            if (Item) {
                return dynamodb_data_marshaller_1.unmarshallItem(schema, Item, item.constructor);
            }
    ...
    parallelScan(ctorOrParams, segments, options = {}) {
        ...
        return new ParallelScanIterator_1.ParallelScanIterator(this.client, valueConstructor, segments, Object.assign(Object.assign({ readConsistency: this.readConsistency }, options), { tableNamePrefix: this.tableNamePrefix }));
    }
    put(itemOrParameters, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return dynamodb_data_marshaller_1.unmarshallItem(schema, req.Item, item.constructor);
        });
    }
    query(valueConstructorOrParameters, keyCondition, options = {}) {
        ...
        return new QueryIterator_1.QueryIterator(this.client, valueConstructor, keyCondition, Object.assign(Object.assign({ readConsistency: this.readConsistency }, options), { tableNamePrefix: this.tableNamePrefix }));
    }
    scan(ctorOrParams, options = {}) {
        ...
        return new ScanIterator_1.ScanIterator(this.client, valueConstructor, Object.assign(Object.assign({ readConsistency: this.readConsistency }, options), { tableNamePrefix: this.tableNamePrefix }));
    }
    update(itemOrParameters, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const schema = protocols_1.getSchema(item);
            const expr = new dynamodb_expressions_1.UpdateExpression();
            const itemKey = {};
            for (const key of Object.keys(schema)) {
                let inputMember = item[key];
                const fieldSchema = schema[key];
                if (dynamodb_data_marshaller_1.isKey(fieldSchema)) {
                    ...
                    const marshalled = dynamodb_data_marshaller_1.marshallValue(fieldSchema, inputMember);
                    if (marshalled) {
                        expr.set(key, new dynamodb_expressions_1.AttributeValue(marshalled));
                    }
                }
            }
            return this.doExecuteUpdateExpression(expr, itemKey, protocols_1.getSchema(item), protocols_1.getTableName(item), item.constructor, { condition });
        });
    }
    /**
    ...
    executeUpdateExpression(expression, key, valueConstructor, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.doExecuteUpdateExpression(expression, key, protocols_1.getSchema(valueConstructor.prototype), protocols_1.getTableName(valueConstructor.prototype), valueConstructor, options);
        });
    }
    doExecuteUpdateExpression(expression, key, schema, tableName, valueConstructor, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (rawResponse.Attributes) {
                return dynamodb_data_marshaller_1.unmarshallItem(schema, rawResponse.Attributes, valueConstructor);
            }
        ...
        return __asyncGenerator(this, arguments, function* mapGetBatch_1() {
            ...
            try {
                for (var items_3 = __asyncValues(items), items_3_1; items_3_1 = yield __await(items_3.next()), !items_3_1.done;) {
                    ...
                    const unprefixed = protocols_1.getTableName(item);
                    ...
                    const { keyProperties, itemSchemata } = state[tableName];
                    const marshalled = dynamodb_data_marshaller_1.marshallKey(schema, item);
...
function convertBatchGetOptions(options, itemSchema) {
    ...
    if (options.projection) {
        const attributes = new dynamodb_expressions_1.ExpressionAttributes();
        out.ProjectionExpression = dynamodb_expressions_1.serializeProjectionExpression(options.projection.map(propName => dynamodb_data_marshaller_1.toSchemaName(propName, options.projectionSchema || itemSchema)), attributes);
...
function indexProjection(schema, projection) {
    ...
    return {
        ...
        NonKeyAttributes: projection.map(propName => dynamodb_data_marshaller_1.getSchemaName(propName, schema))
    };
}
