...
import { ConditionExpression, ConditionExpressionPredicate } from '@awslabs-community-fork/dynamodb-expressions';
import { DynamoDB } from "@aws-sdk/client-dynamodb";
/**
 * Iterates over each item returned by a DynamoDB query until no more pages are
 * available.
 */
export declare class QueryIterator<T> extends Iterator<T, QueryPaginator<T>> {
