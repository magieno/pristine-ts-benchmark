...
import { ConditionExpression, ConditionExpressionPredicate, ProjectionExpression } from '@awslabs-community-fork/dynamodb-expressions';
 ...
 * @deprecated
 */
export interface QueryParameters<T extends StringToAnyObjectMap = StringToAnyObjectMap> extends QueryOptions {
    /**
