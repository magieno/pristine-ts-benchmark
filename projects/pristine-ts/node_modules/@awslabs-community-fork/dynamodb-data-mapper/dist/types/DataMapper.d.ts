...
import { ConditionExpression, ConditionExpressionPredicate, UpdateExpression } from '@awslabs-community-fork/dynamodb-expressions';
/**
...
export declare class DataMapper {
     ...
     */
    batchDelete<T extends StringToAnyObjectMap>(items: SyncOrAsyncIterable<T>): AsyncGenerator<T, void, unknown>;
    /**
     ...
     */
    batchGet<T extends StringToAnyObjectMap>(items: SyncOrAsyncIterable<T>, { readConsistency, perTableOptions }?: BatchGetOptions): AsyncGenerator<T, void, unknown>;
    /**
     ...
     */
    batchPut<T extends StringToAnyObjectMap>(items: SyncOrAsyncIterable<T>): AsyncGenerator<T, void, unknown>;
    /**
     ...
     */
    createTable(valueConstructor: ZeroArgumentsConstructor<any>, options: CreateTableOptions): Promise<void>;
    /**
     ...
     */
    createGlobalSecondaryIndex(valueConstructor: ZeroArgumentsConstructor<any>, indexName: string, { indexOptions, }: CreateTableOptions): Promise<void>;
    /**
     ...
     * @param options           Options to configure the UpdateTable operation
     */
    ensureGlobalSecondaryIndexExists(valueConstructor: ZeroArgumentsConstructor<any>, indexName: string, options: CreateTableOptions): Promise<void>;
    /**
