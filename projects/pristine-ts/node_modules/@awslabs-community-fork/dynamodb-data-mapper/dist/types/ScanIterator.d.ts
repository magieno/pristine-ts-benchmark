 ...
 * available.
 */
export declare class ScanIterator<T> extends Iterator<T, ScanPaginator<T>> {
    constructor(client: DynamoDB, valueConstructor: ZeroArgumentsConstructor<T>, options?: SequentialScanOptions);
}
