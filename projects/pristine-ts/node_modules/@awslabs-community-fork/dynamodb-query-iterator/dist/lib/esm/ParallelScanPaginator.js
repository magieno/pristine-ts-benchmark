...
export class ParallelScanPaginator {
    constructor(client, input, scanState = nullScanState(input.TotalSegments)) {
        ...
        for (let i = 0; i < TotalSegments; i++) {
            const iterator = new ScanPaginator(client, Object.assign(Object.assign({}, input), { Segment: i, ExclusiveStartKey: scanState[i].LastEvaluatedKey }));
    ...
    get consumedCapacity() {
        return this.iterators.reduce((merged, paginator) => mergeConsumedCapacities(merged, paginator.consumedCapacity), undefined);
    }
    /**
     * @inheritDoc
     */
